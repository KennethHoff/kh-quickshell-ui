...
```bash
nix run "git+file://$PWD?rev=9859d176d4dbf3552e2ccb6a9393bd2837d198f6#kh-view" -- <path1> [<path2> ...]
```
...
nix run "git+file://$PWD?rev=9859d176d4dbf3552e2ccb6a9393bd2837d198f6#kh-view" -- /tmp/qs-screenshots/20260412-140000/shot-a.png /tmp/qs-screenshots/20260412-140000/shot-b.png
```
