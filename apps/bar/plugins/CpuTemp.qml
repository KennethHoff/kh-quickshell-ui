// Bar plugin (data source): CPU temperature from /sys/class/hwmon.
// Matches by the sensor's `name` file (default "zenpower" for Ryzen;
// use "coretemp" on Intel, "k10temp" on older Ryzen). Reads `temp1_input`
// in milli-°C. No visuals — compose with a sibling Text to render.
//
